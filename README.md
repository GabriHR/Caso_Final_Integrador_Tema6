...
Clases:
   ...
   - La clase NoDataExcepcion es una excepción personalizada en Java diseñada para manejar situaciones donde falta cierta información en el programa. Al crear una instancia de esta clase, se puede proporcionar un mensaje de error personalizado que se almacenará en la excepción. Este mensaje puede recuperarse más tarde utilizando el método getMessage(). En resumen, NoDataExcepcion permite lanzar una excepción con un mensaje específico para indicar la falta de datos esperados en el programa.
